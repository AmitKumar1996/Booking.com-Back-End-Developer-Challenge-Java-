...
public class Hotel implements Serializable {
  ...
  @Transient
  private double distanceFromCityCentre;  // Added transient field
  ...
  // Added getter and setter for distanceFromCityCentre
  public void setDistanceFromCityCentre(double distance) {
    this.distanceFromCityCentre = distance;
  }
